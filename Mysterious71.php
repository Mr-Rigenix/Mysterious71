...
echo"\033[1;32m        --Your Intelligence Is Our Common Sense--";
 
echo"\033[1;36m        CODED BY AKIL
 ";
 
echo"
";
echo "\033[1;36m        MUSLIM   HACKERS FROM BD    ";
...
$myfile = fopen("Mysterious.html", "w") or die("Unable to open file!");
...
";
echo"\033[1;35m       This deface page saved to your phone storage by the name of deface.html";
...
echo"
";
echo"\033[1;36m               FACEBOOK : MYSTERIOUS 71    ";
echo"
";
echo "\033[1;36m     MUSLIM  HACKERS BD             ";
echo"
";
echo"\033[1;32m -----‐-----------‐----------------------------------";
echo"
